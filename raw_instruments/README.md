...
2. The "Experimental" directory will have the weirder stuff.
3. The "Signals" directory will have your basic signals and frequency modulation, using either SuperCollider's ```SoundIn.ar``` Ugen or its own internal sound.
